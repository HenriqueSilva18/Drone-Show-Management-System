...
| **Status**                                  | Mechanism to see if a show proposal is approved                                                                               | 
...
| **Scrum Master**                            | Role responsible for facilitating the Scrum process, ensuring that the team follows                                          
 Scrum practices and principles.             |
| **Sprint**                                  | Time-boxed period in the Scrum methodology during which specific work must be                                                
 completed and ready for review.             |
| **Test**                                    | Process of executing the code to verify its correctness and functionality.                                                   |
| **Test-Driven**                             | Approach where tests are written before the code to ensure that the code meets the                                           
 requirements and passes the tests.          |
| **Use Case**                                | Description of how a user interacts with the system to achieve a specific goal.                                              |
| **Use Case Diagram**                        | Visual representation of the interactions between users and the system, showing the                                          
